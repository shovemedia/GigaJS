...
/*global signals:false, SignalBinding:false*/
    ...
    if(typeof define === 'function' && define.amd){ //AMD
    	...
    	define('lib/signals',[], function () { return signals; });    	
 ...
 */
 ...
 define('lib/History',['require'],function(require){
...
define('lib/giga/StateMachine',['require','lib/signals'],function(require){
...
define('lib/giga/Step',['require','lib/signals'],function(require){
...
define('lib/giga/SiteController',['require','lib/giga/StateMachine','lib/giga/Step','lib/signals'],function(require){
...
define('lib/giga/FlowController',['require'],function(require){
 ...
 */
define('lib/tween/TweenLite',['require'],function(require){
 ...
 * @author: Jack Doyle, jack@greensock.com
 **/
define('lib/tween/easing/EasePack',['require','lib/tween/TweenLite'],function(require){
 ...
 * @author: Jack Doyle, jack@greensock.com
 */
define('lib/tween/plugins/CSSPlugin',['require','lib/tween/TweenLite'],function(require){

	require('lib/tween/TweenLite');
...
define('lib/giga/TransitionController',['require','jquery','lib/tween/easing/EasePack','lib/signals','lib/tween/TweenLite','lib/tween/TimelineLite','lib/tween/plugins/CSSPlugin'],function(require){
	...
	p.getTransitionSequence = function(inOutAttribute, $content, step)
	{
		...
		if ($content != undefined)
		{
			...
			$content.each(function(){
				...
				{
					console.log ('rel MATCH', rel, $sets.length-1);
					$sets[$sets.length-1] = $sets[$sets.length-1].add($branch);


					//	console.log ($sets[$sets.length-1]);
					//	console.log ($branch);
				}	
