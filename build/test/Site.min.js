...
return!0},a.replaceState=function(c,f,d,l){d=encodeURI(d).replace(/%25/g,"%");if(a.getHashByUrl(d))throw Error("History.js does not support states with fragment-identifiers (hashes/anchors).");if(l!==!1&&a.busy())return a.pushQueue({scope:a,callback:a.replaceState,args:arguments,queue:l}),!1;a.busy(!0);var b=a.createStateObject(c,f,d),e=a.getHashByState(b),g=a.getState(!1),m=a.getHashByState(g),i=a.getStateByIndex(-2);a.discardState(g,b,i);e===m?(a.storeState(b),a.expectedStateId=b.id,a.recycleState(b),
a.setTitle(b),a.saveState(b),a.Adapter.trigger(window,"statechange"),a.busy(!1)):a.pushState(b.data,b.title,b.url,!1);return!0};if(a.emulated.pushState&&a.getHash()&&!a.emulated.hashChange)a.Adapter.onDomLoad(function(){a.Adapter.trigger(window,"hashchange")})};a.init=function(){if(typeof a.Adapter==="undefined")return!1;typeof a.initCore!=="undefined"&&a.initCore();typeof a.initHtml4!=="undefined"&&a.initHtml4();return!0};a.initCore=function(){if(typeof a.initCore.initialized!=="undefined")return!1;
...
"":a}).replace(/\/+$/,"")+"/"};a.getFullUrl=function(d,c){var b=d,f=d.substring(0,1),c=typeof c==="undefined"?!0:c;/[a-z]+\:\/\//.test(d)||(b=f==="/"?a.getRootUrl()+d.replace(/^\/+/,""):f==="#"?a.getPageUrl().replace(/#.*/,"")+d:f==="?"?a.getPageUrl().replace(/[\?#].*/,"")+d:c?a.getBaseUrl()+d.replace(/^(\.\/)+/,""):a.getBasePageUrl()+d.replace(/^(\.\/)+/,""));return b.replace(/\#$/,"")};a.getShortUrl=function(d){var c=a.getBaseUrl(),b=a.getRootUrl();a.emulated.pushState&&(h.log("History.getShortUrl IE ::  shortUrl: "+
...
a.extractId=function(a){return((a=/(.*)\&_suid=([0-9]+)$/.exec(a.indexOf("#")!=-1?a.split("#")[0]:a))?String(a[2]||""):"")||!1};a.isTraditionalAnchor=function(a){return!/[\/\?\.]/.test(a)};a.extractState=function(d,c){var b=null,f,e,c=c||!1;(f=a.extractId(d))&&(b=a.getStateById(f));b||(e=a.getFullUrl(d),(f=a.getIdByUrl(e)||!1)&&(b=a.getStateById(f)),!b&&c&&!a.isTraditionalAnchor(d)&&(b=a.createStateObject(null,null,e)));return b};a.getIdByUrl=function(d){return a.urlToId[d]||a.store.urlToId[d]||void 0};
...
"statechange");a.busy(!1);return!0},a.Adapter.bind(window,"popstate",a.onPopState),a.pushState=function(d,c,b,f){if(a.getHashByUrl(b)&&a.emulated.pushState)throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");if(f!==!1&&a.busy())return a.pushQueue({scope:a,callback:a.pushState,args:arguments,queue:f}),!1;a.busy(!0);var e=a.createStateObject(d,c,b);a.isLastSavedState(e)?a.busy(!1):(a.storeState(e),a.expectedStateId=e.id,o.pushState(e.id,e.title,e.url),a.Adapter.trigger(window,
"popstate"));return!0},a.replaceState=function(d,c,b,f){if(a.getHashByUrl(b)&&a.emulated.pushState)throw Error("History.js does not support states with fragement-identifiers (hashes/anchors).");if(f!==!1&&a.busy())return a.pushQueue({scope:a,callback:a.replaceState,args:arguments,queue:f}),!1;a.busy(!0);var e=a.createStateObject(d,c,b);a.isLastSavedState(e)?a.busy(!1):(a.storeState(e),a.expectedStateId=e.id,o.replaceState(e.id,e.title,e.url),a.Adapter.trigger(window,"popstate"));return!0};if(b)try{a.store=
...
define("lib/tween/TweenLite",["require"],function(){(function(h){var q=h.GreenSockGlobals||h;if(!q.TweenLite){var j=function(a){var a=a.split("."),d=q,c;for(c=0;c<a.length;c++)d[a[c]]=d=d[a[c]]||{};return d},b=j("com.greensock"),p=[].slice,m=function(){},i=function(){var a=Object.prototype.toString,d=a.call([]);return function(c){return c instanceof Array||typeof c==="object"&&!!c.push&&a.call(c)===d}}(),g,k,e,a,o,c={},n=function(a,d,b,f){this.sc=c[a]?c[a].sc:[];c[a]=this;this.gsClass=null;this.func=
b;var e=[];this.check=function(l){for(var g=d.length,i=g,k,m;--g>-1;)(k=c[d[g]]||new n(d[g],[])).gsClass?(e[g]=k.gsClass,i--):l&&k.sc.push(this);if(i===0&&b){l=("com.greensock."+a).split(".");g=l.pop();m=j(l.join("."))[g]=this.gsClass=b.apply(b,e);if(f)if(q[g]=m,typeof define==="function"&&define.amd)define((h.GreenSockAMDPath?h.GreenSockAMDPath+"/":"")+a.split(".").join("/"),[],function(){return m});else if(typeof module!=="undefined"&&module.exports)module.exports=m;for(g=0;g<this.sc.length;g++)this.sc[g].check()}};
...
T(new F(null,null,2,k),e,"easeIn"+(k===0?",easeNone":"")),T(new F(null,null,3,k),e,"easeInOut");Q.linear=b.easing.Linear.easeIn;Q.swing=b.easing.Quad.easeInOut;var U=d("events.EventDispatcher",function(a){this._listeners={};this._eventTarget=a||this});e=U.prototype;e.addEventListener=function(d,c,b,f,e){var e=e||0,g=this._listeners[d],l=0,i;g==null&&(this._listeners[d]=g=[]);for(i=g.length;--i>-1;)d=g[i],d.c===c&&d.s===b?g.splice(i,1):l===0&&d.pr<e&&(l=i+1);g.splice(l,0,{c:c,s:b,up:f,pr:e});this===
...
M=h[g[k]+"CancelAnimationFrame"]||h[g[k]+"CancelRequestAnimationFrame"];d("Ticker",function(d,c){var b=this,f=D(),e=c!==!1&&y,g,l,i,n,k,h=function(a){W=D();b.time=(W-f)/1E3;var d=b.time-k,c;if(!g||d>0||a===!0)b.frame++,k+=d+(d>=n?0.0040:n-d),c=!0;a!==!0&&(i=l(h));c&&b.dispatchEvent("tick")};U.call(b);b.time=b.frame=0;b.tick=function(){h(!0)};b.sleep=function(){i!=null&&(!e||!M?clearTimeout(i):M(i),l=m,i=null,b===a&&(o=!1))};b.wake=function(){i!==null&&b.sleep();l=g===0?m:!e||!y?function(a){return setTimeout(a,
(k-b.time)*1E3+1|0)}:y;b===a&&(o=!0);h(2)};b.fps=function(a){if(!arguments.length)return g;g=a;n=1/(g||60);k=this.time+n;b.wake()};b.useRAF=function(a){if(!arguments.length)return e;b.sleep();e=a;b.fps(g)};b.fps(d);setTimeout(function(){e&&(!i||b.frame<5)&&b.useRAF(!1)},1500)});e=b.Ticker.prototype=new b.events.EventDispatcher;e.constructor=b.Ticker;var s=d("core.Animation",function(d,c){this.vars=c=c||{};this._duration=this._totalDuration=d||0;this._delay=Number(c.delay)||0;this._timeScale=1;this._active=
c.immediateRender===!0;this.data=c.data;this._reversed=c.reversed===!0;if(O){o||a.wake();var b=this.vars.useFrames?u:O;b.add(this,b._time);this.vars.paused&&this.paused(!0)}});a=s.ticker=new b.Ticker;e=s.prototype;e._dirty=e._gc=e._initted=e._paused=!1;e._totalTime=e._time=0;e._rawPrevTime=-1;e._next=e._last=e._onUpdate=e._timeline=e.timeline=null;e._paused=!1;var X=function(){D()-W>2E3&&a.wake();setTimeout(X,2E3)};X();e.play=function(a,d){arguments.length&&this.seek(a,d);return this.reversed(!1).paused(!1)};
...
g=d("core.SimpleTimeline",function(a){s.call(this,0,a);this.autoRemoveChildren=this.smoothChildTiming=!0});e=g.prototype=new s;e.constructor=g;e.kill()._gc=!1;e._first=e._last=null;e._sortChildren=!1;e.add=e.insert=function(a,d){var c,b;a._startTime=Number(d||0)+a._delay;if(a._paused&&this!==a._timeline)a._pauseTime=a._startTime+(this.rawTime()-a._startTime)/a._timeScale;a.timeline&&a.timeline._remove(a,!0);a.timeline=a._timeline=this;a._gc&&a._enabled(!0,!0);c=this._last;if(this._sortChildren)for(b=
...
d,c){var b=this._first,f;for(this._totalTime=this._time=this._rawPrevTime=a;b;){f=b._next;if(b._active||a>=b._startTime&&!b._paused)b._reversed?b.render((!b._dirty?b._totalDuration:b.totalDuration())-(a-b._startTime)*b._timeScale,d,c):b.render((a-b._startTime)*b._timeScale,d,c);b=f}};e.rawTime=function(){o||a.wake();return this._totalTime};var r=d("TweenLite",function(a,d,c){s.call(this,d,c);this.render=r.prototype.render;if(a==null)throw"Cannot tween a null target.";this.target=a=typeof a!=="string"?
a:r.selector(a)||a;var b=a.jquery||a.length&&a!==h&&a[0]&&(a[0]===h||a[0].nodeType&&a[0].style&&!a.nodeType),c=this.vars.overwrite,f;this._overwrite=c=c==null?L[r.defaultOverwrite]:typeof c==="number"?c>>0:L[c];if((b||a instanceof Array||a.push&&i(a))&&typeof a[0]!=="number"){this._targets=f=p.call(a,0);this._propLookup=[];this._siblings=[];for(a=0;a<f.length;a++)(b=f[a])?typeof b==="string"?(b=f[a--]=r.selector(b),typeof b==="string"&&f.splice(a+1,1)):b.length&&b!==h&&b[0]&&(b[0]===h||b[0].nodeType&&
b[0].style&&!b.nodeType)?(f.splice(a--,1),this._targets=f=f.concat(p.call(b,0))):(this._siblings[a]=t(b,this,!1),c===1&&this._siblings[a].length>1&&x(b,this,null,1,this._siblings[a])):f.splice(a--,1)}else this._propLookup={},this._siblings=t(a,this,!1),c===1&&this._siblings.length>1&&x(a,this,null,1,this._siblings);(this.vars.immediateRender||d===0&&this._delay===0&&this.vars.immediateRender!==!1)&&this.render(-this._delay,!1,!0)},!0),P=function(a){return a.length&&a!==h&&a[0]&&(a[0]===h||a[0].nodeType&&
a[0].style&&!a.nodeType)};e=r.prototype=new s;e.constructor=r;e.kill()._gc=!1;e.ratio=0;e._firstPT=e._targets=e._overwrittenProps=e._startAt=null;e._notifyPluginsOfEnabled=!1;r.version="1.11.0";r.defaultEase=e._ease=new F(null,null,1,1);r.defaultOverwrite="auto";r.ticker=a;r.autoSleep=!0;r.selector=h.$||h.jQuery||function(a){return h.$?(r.selector=h.$,h.$(a)):h.document?h.document.getElementById(a.charAt(0)==="#"?a.substr(1):a):a};k=r._internals={isArray:i,isSelector:P};var E=r._plugins={},G=r._tweenLookup=
...
"true":1,"false":0},u=s._rootFramesTimeline=new g,O=s._rootTimeline=new g;O._startTime=a.time;u._startTime=a.frame;O._active=u._active=!0;s._updateRoot=function(){O.render((a.time-O._startTime)*O._timeScale,!1,!1);u.render((a.frame-u._startTime)*u._timeScale,!1,!1);if(!(a.frame%120)){var d,c,b;for(b in G){c=G[b].tweens;for(d=c.length;--d>-1;)c[d]._gc&&c.splice(d,1);c.length===0&&delete G[b]}b=O._first;if((!b||b._paused)&&r.autoSleep&&!u._first&&a._listeners.tick.length===1){for(;b&&b._paused;)b=b._next;
b||a.sleep()}}};a.addEventListener("tick",s._updateRoot);var t=function(a,d,c){var b=a._gsTweenID,f;if(!G[b||(a._gsTweenID=b="t"+Y++)])G[b]={target:a,tweens:[]};if(d&&(a=G[b].tweens,a[f=a.length]=d,c))for(;--f>-1;)a[f]===d&&a.splice(f,1);return G[b].tweens},x=function(a,d,c,b,f){var e,g,l;if(b===1||b>=4){a=f.length;for(e=0;e<a;e++)if((l=f[e])!==d)l._gc||l._enabled(!1,!1)&&(g=!0);else if(b===5)break;return g}var i=d._startTime+1.0E-10,n=[],k=0,h=d._duration===0,m;for(e=f.length;--e>-1;)if(!((l=f[e])===
d||l._gc||l._paused))l._timeline!==d._timeline?(m=m||z(d,0,h),z(l,m,h)===0&&(n[k++]=l)):l._startTime<=i&&l._startTime+l.totalDuration()/l._timeScale+1.0E-10>i&&((h||!l._initted)&&i-l._startTime<=2.0E-10||(n[k++]=l));for(e=k;--e>-1;)if(l=n[e],b===2&&l._kill(c,a)&&(g=!0),b!==2||!l._firstPT&&l._initted)l._enabled(!1,!1)&&(g=!0);return g},z=function(a,d,c){for(var b=a._timeline,f=b._timeScale,e=a._startTime;b._timeline;){e+=b._startTime;f*=b._timeScale;if(b._paused)return-100;b=b._timeline}e/=f;return e>
d?e-d:c&&e===d||!a._initted&&e-d<2.0E-10?1.0E-10:(e+=a.totalDuration()/a._timeScale/f)>d+1.0E-10?0:e-d-1.0E-10};e._init=function(){var a=this.vars,d=this._overwrittenProps,c=this._duration,b=a.immediateRender,f=a.ease,e,l;if(a.startAt){if(this._startAt&&this._startAt.render(-1,!0),a.startAt.overwrite=0,a.startAt.immediateRender=!0,this._startAt=r.to(this.target,0,a.startAt),b)if(this._time>0)this._startAt=null;else if(c!==0)return}else if(a.runBackwards&&c!==0)if(this._startAt)this._startAt.render(-1,
!0),this._startAt=null;else{c={};for(l in a)if(!K[l]||l==="autoCSS")c[l]=a[l];c.overwrite=0;c.data="isFromStart";this._startAt=r.to(this.target,0,c);if(a.immediateRender){if(this._time===0)return}else this._startAt.render(-1,!0)}this._ease=f?f instanceof F?a.easeParams instanceof Array?f.config.apply(f,a.easeParams):f:typeof f==="function"?new F(f,a.easeParams):Q[f]||r.defaultEase:r.defaultEase;this._easeType=this._ease._type;this._easePower=this._ease._power;this._firstPT=null;if(this._targets)for(f=
this._targets.length;--f>-1;){if(this._initProps(this._targets[f],this._propLookup[f]={},this._siblings[f],d?d[f]:null))e=!0}else e=this._initProps(this.target,this._propLookup,this._siblings,d);e&&r._onPluginEvent("_onInitAllProps",this);d&&(this._firstPT||typeof this.target!=="function"&&this._enabled(!1,!1));if(a.runBackwards)for(c=this._firstPT;c;)c.s+=c.c,c.c=-c.c,c=c._next;this._onUpdate=a.onUpdate;this._initted=!0};e._initProps=function(a,d,c,b){var f,e,l,g,n;if(a==null)return!1;if(!this.vars.css&&
...
n===1.0E-10)&&n!==a)c=!0,n>1.0E-10&&(l="onReverseComplete");this._rawPrevTime=n=!d||a?a:1.0E-10}}else if(a<1.0E-7){this._totalTime=this._time=0;this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0;if(b!==0||f===0&&this._rawPrevTime>1.0E-10)l="onReverseComplete",e=this._reversed;if(a<0){if(this._active=!1,f===0)this._rawPrevTime>=0&&(c=!0),this._rawPrevTime=n=!d||a?a:1.0E-10}else this._initted||(c=!0)}else if(this._totalTime=this._time=a,this._easeType){g=a/f;var i=this._easeType,m=this._easePower;
if(i===1||i===3&&g>=0.5)g=1-g;i===3&&(g*=2);m===1?g*=g:m===2?g*=g*g:m===3?g*=g*g*g:m===4&&(g*=g*g*g*g);this.ratio=i===1?1-g:i===2?g:a/f<0.5?g/2:1-g/2}else this.ratio=this._ease.getRatio(a/f);if(this._time!==b||c){if(!this._initted){this._init();if(!this._initted||this._gc)return;if(this._time&&!e)this.ratio=this._ease.getRatio(this._time/f);else if(e&&this._ease._calcEnd)this.ratio=this._ease.getRatio(this._time===0?0:1)}if(!this._active&&!this._paused&&this._time!==b&&a>=0)this._active=!0;if(b===
...
"object"||!a._tempKill);for(f in l){if(c=e[f]){c.pg&&c.t._kill(l)&&(g=!0);if(!c.pg||c.t._overwriteProps.length===0){if(c._prev)c._prev._next=c._next;else if(c===this._firstPT)this._firstPT=c._next;if(c._next)c._next._prev=c._prev;c._next=c._prev=null}delete e[f]}n&&(b[f]=1)}!this._firstPT&&this._initted&&this._enabled(!1,!1)}}return g};e.invalidate=function(){this._notifyPluginsOfEnabled&&r._onPluginEvent("_onDisable",this);this._startAt=this._onUpdate=this._overwrittenProps=this._firstPT=null;this._initted=
this._active=this._notifyPluginsOfEnabled=!1;this._propLookup=this._targets?{}:[];return this};e._enabled=function(d,c){o||a.wake();if(d&&this._gc){var b=this._targets,f;if(b)for(f=b.length;--f>-1;)this._siblings[f]=t(b[f],this,!0);else this._siblings=t(this.target,this,!0)}s.prototype._enabled.call(this,d,c);return this._notifyPluginsOfEnabled&&this._firstPT?r._onPluginEvent(d?"_onEnable":"_onDisable",this):!1};r.to=function(a,d,c){return new r(a,d,c)};r.from=function(a,d,c){c.runBackwards=!0;c.immediateRender=
c.immediateRender!=!1;return new r(a,d,c)};r.fromTo=function(a,d,c,b){b.startAt=c;b.immediateRender=b.immediateRender!=!1&&c.immediateRender!=!1;return new r(a,d,b)};r.delayedCall=function(a,d,c,b,f){return new r(d,0,{delay:a,onComplete:d,onCompleteParams:c,onCompleteScope:b,onReverseComplete:d,onReverseCompleteParams:c,onReverseCompleteScope:b,immediateRender:!1,useFrames:f,overwrite:0})};r.set=function(a,d){return new r(a,0,d)};r.getTweensOf=function(a,d){if(a==null)return[];var a=typeof a!=="string"?
a:r.selector(a)||a,c,b,f,e;if((i(a)||P(a))&&typeof a[0]!=="number"){c=a.length;for(b=[];--c>-1;)b=b.concat(r.getTweensOf(a[c],d));for(c=b.length;--c>-1;){e=b[c];for(f=c;--f>-1;)e===b[f]&&b.splice(c,1)}}else{b=t(a).concat();for(c=b.length;--c>-1;)(b[c]._gc||d&&!b[c].isActive())&&b.splice(c,1)}return b};r.killTweensOf=r.killDelayedCallsTo=function(a,d,c){typeof d==="object"&&(c=d,d=!1);for(var d=r.getTweensOf(a,d),b=d.length;--b>-1;)d[b]._kill(c,a)};var C=d("plugins.TweenPlugin",function(a,d){this._overwriteProps=
...
m=a.clamp===!0,k=a.template instanceof h?a.template:null,a=typeof a.strength==="number"?a.strength*0.4:0.4,j,o,p;--n>-1;)j=i?Math.random():1/g*n,o=k?k.getRatio(j):j,c==="none"?p=a:c==="out"?(p=1-j,p=p*p*a):c==="in"?p=j*j*a:(p=j<0.5?j*2:(1-j)*2,p=p*p*0.5*a),i?o+=Math.random()*p-p*0.5:n%2?o+=p*0.5:o-=p*0.5,m&&(o>1?o=1:o<0&&(o=0)),b[f++]={x:j,y:o};b.sort(function(a,c){return a.x-c.x});c=new e(1,1,null);for(n=g;--n>-1;)g=b[n],c=new e(g.x,g.y,c);this._prev=new e(0,0,c.t!==0?c:c.next)},!0);c=f.prototype=
...
b,f,d,e,g,i,h)};o.staggerFromTo=function(a,b,f,d,e,g,i,h,m){d.startAt=f;d.immediateRender=d.immediateRender!=!1&&f.immediateRender!=!1;return this.staggerTo(a,b,d,e,g,i,h,m)};o.call=function(a,e,f,d){return this.add(b.delayedCall(0,a,e,f),d)};o.set=function(a,e,f){f=this._parseTimeOrLabel(f,0,!0);if(e.immediateRender==null)e.immediateRender=f===this._time&&!this._paused;return this.add(new b(a,0,e),f)};p.exportRoot=function(a,e){a=a||{};if(a.smoothChildTiming==null)a.smoothChildTiming=!0;var f=new p(a),
d=f._timeline,g,i;e==null&&(e=!0);d._remove(f,!0);f._startTime=0;f._rawPrevTime=f._time=f._totalTime=d._time;for(g=d._first;g;)i=g._next,(!e||!(g instanceof b&&g.target===g.vars.onComplete))&&f.add(g,g._startTime-g._delay),g=i;d.add(f,0);return f};o.add=function(a,e,f,d){var g,m,k;typeof e!=="number"&&(e=this._parseTimeOrLabel(e,0,!0,a));if(!(a instanceof h))if(a instanceof Array||a&&a.push&&i(a)){f=f||"normal";d=d||0;g=a.length;for(m=0;m<g;m++){if(i(k=a[m]))k=new p({tweens:k});this.add(k,e);typeof k!==
"string"&&typeof k!=="function"&&(f==="sequence"?e=k._startTime+k.totalDuration()/k._timeScale:f==="start"&&(k._startTime-=k.delay()));e+=d}return this._uncache(!0)}else if(typeof a==="string")return this.addLabel(a,e);else if(typeof a==="function")a=b.delayedCall(0,a);else throw"Cannot add "+a+" into the timeline; it is not a tween, timeline, function, or string.";j.prototype.add.call(this,a,e);if(this._gc&&!this._paused&&this._duration<this.duration()){f=this;for(a=f.rawTime()>a._startTime;f._gc&&
...
b)};o.gotoAndStop=function(a,b){return this.pause(a,b)};o.render=function(a,b,e){this._gc&&this._enabled(!0,!1);var d=!this._dirty?this._totalDuration:this.totalDuration(),i=this._time,m=this._startTime,h=this._timeScale,k=this._paused,j,o,q,p;if(a>=d){this._totalTime=this._time=d;if(!this._reversed&&!this._hasPausedChild()&&(o=!0,p="onComplete",this._duration===0&&(a===0||this._rawPrevTime<0||this._rawPrevTime===1.0E-10)&&this._rawPrevTime!==a&&this._first))j=!0,this._rawPrevTime>1.0E-10&&(p="onReverseComplete");
...
j){if(!this._initted)this._initted=!0;if(!this._active&&!this._paused&&this._time!==i&&a>0)this._active=!0;i===0&&this.vars.onStart&&this._time!==0&&(b||this.vars.onStart.apply(this.vars.onStartScope||this,this.vars.onStartParams||g));if(this._time>=i)for(j=this._first;j;){q=j._next;if(this._paused&&!k)break;else if(j._active||j._startTime<=this._time&&!j._paused&&!j._gc)j._reversed?j.render((!j._dirty?j._totalDuration:j.totalDuration())-(a-j._startTime)*j._timeScale,b,e):j.render((a-j._startTime)*
j._timeScale,b,e);j=q}else for(j=this._last;j;){q=j._prev;if(this._paused&&!k)break;else if(j._active||j._startTime<=i&&!j._paused&&!j._gc)j._reversed?j.render((!j._dirty?j._totalDuration:j.totalDuration())-(a-j._startTime)*j._timeScale,b,e):j.render((a-j._startTime)*j._timeScale,b,e);j=q}this._onUpdate&&(b||this._onUpdate.apply(this.vars.onUpdateScope||this,this.vars.onUpdateParams||g));if(p&&!this._gc&&(m===this._startTime||h!==this._timeScale))if(this._time===0||d>=this.totalDuration()){if(o)this._timeline.autoRemoveChildren&&
this._enabled(!1,!1),this._active=!1;!b&&this.vars[p]&&this.vars[p].apply(this.vars[p+"Scope"]||this,this.vars[p+"Params"]||g)}}};o._hasPausedChild=function(){for(var a=this._first;a;){if(a._paused||a instanceof p&&a._hasPausedChild())return!0;a=a._next}return!1};o.getChildren=function(a,e,f,d){for(var d=d||-9999999999,g=[],i=this._first,m=0;i;){if(!(i._startTime<d))if(i instanceof b)e!==!1&&(g[m++]=i);else if(f!==!1&&(g[m++]=i),a!==!1)g=g.concat(i.getChildren(!0,e,f)),m=g.length;i=i._next}return g};
...
s=/,(?=[^\)]*(?:\(|$))/gi,X=Math.PI/180,r=180/Math.PI,P={},E=document,G=E.createElement("div"),Y=E.createElement("img"),K=b._internals={_specialProps:k},L=navigator.userAgent,u,O,t,x,z,C,A=function(){var a=L.indexOf("Android"),b=E.createElement("div");z=(t=L.indexOf("Safari")!==-1&&L.indexOf("Chrome")===-1&&(a===-1||Number(L.substr(a+8,1))>3))&&Number(L.substr(L.indexOf("Version/")+8,1))<6;x=L.indexOf("Firefox")!==-1;/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(L);C=parseFloat(RegExp.$1);b.innerHTML="<a style='top:1px;opacity:.55;'>a</a>";
...
")","gi"),ta=function(b,d,e,f){if(b==null)return function(a){return a};var g=d?(b.match(da)||[""])[0]:"",i=b.split(g).join("").match(c)||[],m=b.substr(0,b.indexOf(i[0])),h=b.charAt(b.length-1)===")"?")":"",k=b.indexOf(" ")!==-1?" ":",",v=i.length,j=v>0?i[0].replace(a,""):"",l;if(!v)return function(a){return a};return d?l=function(a){var b,d,R;if(typeof a==="number")a+=j;else if(f&&s.test(a)){a=a.replace(s,"|").split("|");for(R=0;R<a.length;R++)a[R]=l(a[R]);return a.join(",")}b=(a.match(da)||[g])[0];
d=a.split(b).join("").match(c)||[];R=d.length;if(v>R--)for(;++R<v;)d[R]=e?d[(R-1)/2|0]:i[R];return m+d.join(k)+k+b+h+(a.indexOf("inset")!==-1?" inset":"")}:l=function(a){var b;if(typeof a==="number")a+=j;else if(f&&s.test(a)){b=a.replace(s,"|").split("|");for(a=0;a<b.length;a++)b[a]=l(b[a]);return b.join(",")}b=a.match(c)||[];a=b.length;if(v>a--)for(;++a<v;)b[a]=e?b[(a-1)/2|0]:i[a];return m+b.join(k)+h}},ua=function(a){a=a.split(",");return function(b,c,d,e,f,g,i){c=(c+"").split(" ");i={};for(d=0;d<
...
b;this.v=c;this.r=e;if(d)d._prev=this,this._next=d};K._parseToProxy=function(a,b,c,d,e,f){var g=d,i={},m={},v=c._transform,h=P,k;c._transform=null;P=b;d=a=c.parse(a,b,d,e);P=h;if(f&&(c._transform=v,g&&(g._prev=null,g._prev)))g._prev._next=null;for(;d&&d!==g;){if(d.type<=1){v=d.p;m[v]=d.s+d.c;i[v]=d.s;if(!f)k=new oa(d,"s",v,k,d.r),d.c=0;if(d.type===1)for(c=d.l;--c>0;)h="xn"+c,v=d.p+"_"+h,m[v]=d.data[h],i[v]=d[h],f||(k=new oa(d,h,v,k,d.rxp[h]))}d=d._next}return{proxy:i,end:m,firstMPT:k,pt:a}};var I=
K.CSSPropTween=function(a,b,d,c,e,f,i,m,h,v,k){this.t=a;this.p=b;this.s=d;this.c=c;this.n=i||"css_"+b;a instanceof I||g.push(this.n);this.r=m;this.type=f||0;if(h)this.pr=h,p=!0;this.b=v===void 0?d:v;this.e=k===void 0?d+c:k;if(e)this._next=e,e._prev=this},ja=b.parseComplex=function(b,d,c,e,f,g,i,m,h,v){i=new I(b,d,0,0,i,v?2:1,null,!1,m,c,e);e+="";var b=c.split(", ").join(",").split(" "),d=e.split(", ").join(",").split(" "),m=b.length,k=u!==!1,j,l,n,t;if(e.indexOf(",")!==-1||c.indexOf(",")!==-1)b=b.join(" ").replace(s,
", ").split(" "),d=d.join(" ").replace(s,", ").split(" "),m=b.length;if(m!==d.length)b=(g||"").split(" "),m=b.length;i.plugin=h;i.setRatio=v;for(c=0;c<m;c++)if(g=b[c],v=d[c],(h=parseFloat(g))||h===0)i.appendXtra("",h,sa(v,h),v.replace(o,""),k&&v.indexOf("px")!==-1,!0);else if(f&&(g.charAt(0)==="#"||ca[g]||F.test(g)))j=v.charAt(v.length-1)===","?"),":")",g=qa(g),v=qa(v),(h=g.length+v.length>6)&&!A&&v[3]===0?(i["xs"+i.l]+=i.l?" transparent":"transparent",i.e=i.e.split(d[c]).join("transparent")):(A||
(h=!1),i.appendXtra(h?"rgba(":"rgb(",g[0],v[0]-g[0],",",!0,!0).appendXtra("",g[1],v[1]-g[1],",",!0).appendXtra("",g[2],v[2]-g[2],h?",":j,!0),h&&(g=g.length<4?1:g[3],i.appendXtra("",g,(v.length<4?1:v[3])-g,j,!1)));else if(h=g.match(a)){l=v.match(o);if(!l||l.length!==h.length)return i;for(v=j=0;v<h.length;v++)t=h[v],n=g.indexOf(t,j),i.appendXtra(g.substr(j,n-j),Number(t),sa(l[v],t),"",k&&g.substr(n+t.length,2)==="px",v===0),j=n+t.length;i["xs"+i.l]+=g.substr(j)}else i["xs"+i.l]+=i.l?" "+g:g;if(e.indexOf("=")!==
...
b.priority||0},w=K._registerComplexSpecialProp=function(a,b,c){typeof b!=="object"&&(b={parser:c});var a=a.split(","),d=b.defaultValue,e,c=c||[d];for(e=0;e<a.length;e++)b.prefix=e===0&&b.prefix,b.defaultValue=c[e]||d,new va(a[e],b)},K=function(a){if(!k[a]){var b=a.charAt(0).toUpperCase()+a.substr(1)+"Plugin";w(a,{parser:function(a,c,d,e,g,f,i){var m=(window.GreenSockGlobals||window).com.greensock.plugins[b];if(!m)return window.console&&console.log("Error: "+b+" js file not loaded."),g;m._cssRegister();
return k[d].parse(a,c,d,e,g,f,i)}})}},e=va.prototype;e.parseComplex=function(a,b,c,d,e,g){var f=this.keyword,i,m,h,k;this.multi&&(s.test(c)||s.test(b)?(m=b.replace(s,"|").split("|"),h=c.replace(s,"|").split("|")):f&&(m=[b],h=[c]));if(h){k=h.length>m.length?h.length:m.length;for(i=0;i<k;i++)b=m[i]=m[i]||this.dflt,c=h[i]=h[i]||this.dflt,f&&(b=b.indexOf(f),c=c.indexOf(f),b!==c&&(c=c===-1?h:m,c[i]+=" "+f));b=m.join(", ");c=h.join(", ")}return ja(a,this.p,b,c,this.clrs,this.dflt,d,this.pr,e,g)};e.parse=
function(a,b,c,d,e,g){return this.parseComplex(a.style,this.format(B(a,this.p,i,!1,this.dflt)),this.format(b),e,g)};b.registerSpecialProp=function(a,b,c){w(a,{parser:function(a,d,e,g,f,i){f=new I(a,e,0,0,f,2,e,!1,c);f.plugin=i;f.setRatio=b(a,d,g._tween,e);return f},priority:c})};var wa="scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","),S=ea("transform"),Ba=V+"transform",xa=ea("transformOrigin"),Z=ea("perspective")!==null,ia=function(a,c,d){var e=d?a._gsTransform||
{skewY:0}:{skewY:0},f=e.scaleX<0,g=-Math.PI+1.0E-4,i=Math.PI-1.0E-4,m=Z?parseFloat(B(a,xa,c,!1,"0 0 0").split(" ")[2])||e.zOrigin||0:0,h,k,j,l,o,t,n;if(S)h=B(a,Ba,c,!0);else if(a.currentStyle)if((h=a.currentStyle.filter.match(D))&&h.length===4)h=[h[0].substr(4),Number(h[2].substr(4)),Number(h[1].substr(4)),h[3].substr(4),e.x||0,e.y||0].join(",");else if(e.x!=null)return e;else h="";k=(h||"").match(/(?:\-|\b)[\d\-\.e]+\b/gi)||[];for(h=k.length;--h>-1;)j=Number(k[h]),k[h]=(l=j-(j|=0))?(l*1E5+(l<0?-0.5:
0.5)|0)/1E5+j:j;if(k.length===16){f=k[8];c=k[9];l=k[10];j=k[12];n=k[13];var p=k[14];e.zOrigin&&(p=-e.zOrigin,j=f*p-k[12],n=c*p-k[13],p=l*p+e.zOrigin-k[14]);if(!d||e.rotationX==null){var q=k[0],x=k[1],r=k[2],C=k[3],z=k[4],A=k[5],J=k[6],V=k[7];k=k[11];var s=e.rotationX=Math.atan2(J,l),F=s<g||s>i,H,y,u,w;s&&(u=Math.cos(-s),w=Math.sin(-s),s=z*u+f*w,H=A*u+c*w,y=J*u+l*w,f=z*-w+f*u,c=A*-w+c*u,l=J*-w+l*u,k=V*-w+k*u,z=s,A=H,J=y);if(s=e.rotationY=Math.atan2(f,q))o=s<g||s>i,u=Math.cos(-s),w=Math.sin(-s),H=x*
u-c*w,y=r*u-l*w,c=x*w+c*u,l=r*w+l*u,k=C*w+k*u,q=q*u-f*w,x=H,r=y;if(s=e.rotation=Math.atan2(x,A))t=s<g||s>i,u=Math.cos(-s),w=Math.sin(-s),q=q*u+z*w,H=x*u+A*w,A=x*-w+A*u,J=r*-w+J*u,x=H;if(t&&F)e.rotation=e.rotationX=0;else if(t&&o)e.rotation=e.rotationY=0;else if(o&&F)e.rotationY=e.rotationX=0;e.scaleX=(Math.sqrt(q*q+x*x)*1E5+0.5|0)/1E5;e.scaleY=(Math.sqrt(A*A+c*c)*1E5+0.5|0)/1E5;e.scaleZ=(Math.sqrt(J*J+l*l)*1E5+0.5|0)/1E5;e.skewX=0;e.perspective=k?1/(k<0?-k:k):0;e.x=j;e.y=n;e.z=p}}else if((!Z||k.length===
0||e.x!==k[4]||e.y!==k[5]||!e.rotationX&&!e.rotationY)&&!(e.x!==void 0&&B(a,"display",c)==="none")){l=(o=k.length>=6)?k[0]:1;j=k[1]||0;c=k[2]||0;n=o?k[3]:1;e.x=k[4]||0;e.y=k[5]||0;o=Math.sqrt(l*l+j*j);t=Math.sqrt(n*n+c*c);k=l||j?Math.atan2(j,l):e.rotation||0;c=c||n?Math.atan2(c,n)+k:e.skewX||0;l=o-Math.abs(e.scaleX||0);j=t-Math.abs(e.scaleY||0);Math.abs(c)>Math.PI/2&&Math.abs(c)<Math.PI*1.5&&(f?(o*=-1,c+=k<=0?Math.PI:-Math.PI,k+=k<=0?Math.PI:-Math.PI):(t*=-1,c+=c<=0?Math.PI:-Math.PI));f=(k-e.rotation)%
Math.PI;n=(c-e.skewX)%Math.PI;if(e.skewX===void 0||l>2.0E-5||l<-2.0E-5||j>2.0E-5||j<-2.0E-5||f>g&&f<i&&f*1E5|0||n>g&&n<i&&n*1E5|0)e.scaleX=o,e.scaleY=t,e.rotation=k,e.skewX=c;if(Z)e.rotationX=e.rotationY=e.z=0,e.perspective=parseFloat(b.defaultTransformPerspective)||0,e.scaleZ=1}e.zOrigin=m;for(h in e)e[h]<2.0E-5&&e[h]>-2.0E-5&&(e[h]=0);if(d)a._gsTransform=e;return e},Ca=function(a){var b=this.data,c=-b.rotation,e=c+b.skewX,g=(Math.cos(c)*b.scaleX*1E5|0)/1E5,c=(Math.sin(c)*b.scaleX*1E5|0)/1E5,i=(Math.sin(e)*
-b.scaleY*1E5|0)/1E5,e=(Math.cos(e)*b.scaleY*1E5|0)/1E5,k=this.t.style,h=this.t.currentStyle,m,j;if(h){j=c;c=-i;i=-j;m=h.filter;k.filter="";var l=this.t.offsetWidth;j=this.t.offsetHeight;var n=h.position!=="absolute",o="progid:DXImageTransform.Microsoft.Matrix(M11="+g+", M12="+c+", M21="+i+", M22="+e,t=b.x,p=b.y,q,x;b.ox!=null&&(q=(b.oxp?l*b.ox*0.01:b.ox)-l/2,x=(b.oyp?j*b.oy*0.01:b.oy)-j/2,t+=q-(q*g+x*c),p+=x-(q*i+x*e));if(n)q=l/2,x=j/2,o+=", Dx="+(q-(q*g+x*c)+t)+", Dy="+(x-(q*i+x*e)+p)+")";else{var r=
C<8?1:-1;q=b.ieOffsetX||0;x=b.ieOffsetY||0;b.ieOffsetX=Math.round((l-((g<0?-g:g)*l+(c<0?-c:c)*j))/2+t);b.ieOffsetY=Math.round((j-((e<0?-e:e)*j+(i<0?-i:i)*l))/2+p);for(N=0;N<4;N++)l=Aa[N],j=h[l],j=j.indexOf("px")!==-1?parseFloat(j):H(this.t,l,parseFloat(j),j.replace(f,""))||0,t=j!==b[l]?N<2?-b.ieOffsetX:-b.ieOffsetY:N<2?q-b.ieOffsetX:x-b.ieOffsetY,k[l]=(b[l]=Math.round(j-t*(N===0||N===2?1:r)))+"px";o+=", sizingMethod='auto expand')"}k.filter=m.indexOf("DXImageTransform.Microsoft.Matrix(")!==-1?m.replace(W,
o):o+" "+m;if(a===0||a===1)if(g===1&&c===0&&i===0&&e===1&&(!n||o.indexOf("Dx=0, Dy=0")!==-1))(!d.test(m)||parseFloat(RegExp.$1)===100)&&m.indexOf("gradient(")===-1&&k.removeAttribute("filter")}},Da=function(){var a=this.data,b=this.t.style,c=a.perspective,d=a.scaleX,e=0,g=0,f=0,i=0,k=a.scaleY,h=0,m=0,j=0,l=0,o=a.scaleZ,n=0,t=0,q=0,p=c?-1/c:0,r=a.rotation,C=a.zOrigin,z,s,A,u,J;if(x)z=b.top?"top":b.bottom?"bottom":parseFloat(B(this.t,"top",null,!1))?"bottom":"top",s=B(this.t,z,null,!1),A=parseFloat(s)||
0,u=s.substr((A+"").length)||"px",a._ffFix=!a._ffFix,b[z]=(a._ffFix?A+0.05:A-0.05)+u;if(r||a.skewX)s=d*Math.cos(r),A=k*Math.sin(r),r-=a.skewX,e=d*-Math.sin(r),k*=Math.cos(r),d=s,i=A;if(r=a.rotationY)z=Math.cos(r),r=Math.sin(r),u=o*-r,J=p*-r,g=d*r,h=i*r,o*=z,p*=z,d*=z,i*=z,j=u,t=J;if(r=a.rotationX)z=Math.cos(r),r=Math.sin(r),s=e*z+g*r,A=k*z+h*r,u=l*z+o*r,J=q*z+p*r,g=e*-r+g*z,h=k*-r+h*z,o=l*-r+o*z,p=q*-r+p*z,e=s,k=A,l=u,q=J;C&&(n-=C,f=g*n,m=h*n,n=o*n+C);f=(s=(f+=a.x)-(f|=0))?(s*1E5+(s<0?-0.5:0.5)|0)/
1E5+f:f;m=(s=(m+=a.y)-(m|=0))?(s*1E5+(s<0?-0.5:0.5)|0)/1E5+m:m;n=(s=(n+=a.z)-(n|=0))?(s*1E5+(s<0?-0.5:0.5)|0)/1E5+n:n;b[S]="matrix3d("+[(d*1E5|0)/1E5,(i*1E5|0)/1E5,(j*1E5|0)/1E5,(t*1E5|0)/1E5,(e*1E5|0)/1E5,(k*1E5|0)/1E5,(l*1E5|0)/1E5,(q*1E5|0)/1E5,(g*1E5|0)/1E5,(h*1E5|0)/1E5,(o*1E5|0)/1E5,(p*1E5|0)/1E5,f,m,n,c?1+-n/c:1].join(",")+")"},Ea=function(){var a=this.data,b=this.t,c=b.style,d,e,f;if(x)d=c.top?"top":c.bottom?"bottom":parseFloat(B(b,"top",null,!1))?"bottom":"top",e=B(b,d,null,!1),b=parseFloat(e)||
0,e=e.substr((b+"").length)||"px",a._ffFix=!a._ffFix,c[d]=(a._ffFix?b+0.05:b-0.05)+e;!a.rotation&&!a.skewX?c[S]="matrix("+a.scaleX+",0,0,"+a.scaleY+","+a.x+","+a.y+")":(d=a.rotation,b=d-a.skewX,e=a.scaleX*1E5,f=a.scaleY*1E5,c[S]="matrix("+(Math.cos(d)*e|0)/1E5+","+(Math.sin(d)*e|0)/1E5+","+(Math.sin(b)*-f|0)/1E5+","+(Math.cos(b)*f|0)/1E5+","+a.x+","+a.y+")")};w("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation",
{parser:function(a,b,c,d,e,f,g){if(d._transform)return e;var b=d._transform=ia(a,i,!0),k=a.style,m=wa.length,h={},j,l,n,o,t;if(typeof g.transform==="string"&&S)l=k.cssText,k[S]=g.transform,k.display="block",j=ia(a,null,!1),k.cssText=l;else if(typeof g==="object"){j={scaleX:ba(g.scaleX!=null?g.scaleX:g.scale,b.scaleX),scaleY:ba(g.scaleY!=null?g.scaleY:g.scale,b.scaleY),scaleZ:ba(g.scaleZ!=null?g.scaleZ:g.scale,b.scaleZ),x:ba(g.x,b.x),y:ba(g.y,b.y),z:ba(g.z,b.z),perspective:ba(g.transformPerspective,
b.perspective)};n=g.directionalRotation;if(n!=null)if(typeof n==="object")for(l in n)g[l]=n[l];else g.rotation=n;j.rotation=ha("rotation"in g?g.rotation:"shortRotation"in g?g.shortRotation+"_short":"rotationZ"in g?g.rotationZ:b.rotation*r,b.rotation,"rotation",h);if(Z)j.rotationX=ha("rotationX"in g?g.rotationX:"shortRotationX"in g?g.shortRotationX+"_short":b.rotationX*r||0,b.rotationX,"rotationX",h),j.rotationY=ha("rotationY"in g?g.rotationY:"shortRotationY"in g?g.shortRotationY+"_short":b.rotationY*
r||0,b.rotationY,"rotationY",h);j.skewX=g.skewX==null?b.skewX:ha(g.skewX,b.skewX);j.skewY=g.skewY==null?b.skewY:ha(g.skewY,b.skewY);if(l=j.skewY-b.skewY)j.skewX+=l,j.rotation+=l}o=b.z||b.rotationX||b.rotationY||j.z||j.rotationX||j.rotationY||j.perspective;if(!o&&g.scale!=null)j.scaleZ=1;for(;--m>-1;)if(c=wa[m],n=j[c]-b[c],n>1.0E-6||n<-1.0E-6||P[c]!=null){t=!0;e=new I(b,c,b[c],n,e);if(c in h)e.e=h[c];e.xs0=0;e.plugin=f;d._overwriteProps.push(e.n)}if((n=g.transformOrigin)||Z&&o&&b.zOrigin)S?(t=!0,n=
(n||B(a,c,i,!1,"50% 50%"))+"",c=xa,e=new I(k,c,0,0,e,-1,"css_transformOrigin"),e.b=k[c],e.plugin=f,Z?(l=b.zOrigin,n=n.split(" "),b.zOrigin=(n.length>2?parseFloat(n[2]):l)||0,e.xs0=e.e=k[c]=n[0]+" "+(n[1]||"50%")+" 0px",e=new I(b,"zOrigin",0,0,e,-1,e.n),e.b=l,e.xs0=e.e=b.zOrigin):e.xs0=e.e=k[c]=n):ma(n+"",b);if(t)d._transformType=o||this._transformType===3?3:2;return e},prefix:!0});w("boxShadow",{defaultValue:"0px 0px 0px 0px #999",prefix:!0,color:!0,multi:!0,keyword:"inset"});w("borderRadius",{defaultValue:"0px",
parser:function(a,b,c,d,e){var b=this.format(b),d=["borderTopLeftRadius","borderTopRightRadius","borderBottomRightRadius","borderBottomLeftRadius"],g=a.style,f,k,h,j,l,n,o,t,q,p,x,r;t=parseFloat(a.offsetWidth);q=parseFloat(a.offsetHeight);b=b.split(" ");for(f=0;f<d.length;f++)this.p.indexOf("border")&&(d[f]=ea(d[f])),j=h=B(a,d[f],i,!1,"0px"),j.indexOf(" ")!==-1&&(h=j.split(" "),j=h[0],h=h[1]),l=k=b[f],n=parseFloat(j),x=j.substr((n+"").length),(r=l.charAt(1)==="=")?(o=parseInt(l.charAt(0)+"1",10),
l=l.substr(2),o*=parseFloat(l),p=l.substr((o+"").length-(o<0?1:0))||""):(o=parseFloat(l),p=l.substr((o+"").length)),p===""&&(p=m[c]||x),p!==x&&(j=H(a,"borderLeft",n,x),n=H(a,"borderTop",n,x),p==="%"?(j=j/t*100+"%",h=n/q*100+"%"):p==="em"?(x=H(a,"borderLeft",1,"em"),j=j/x+"em",h=n/x+"em"):(j+="px",h=n+"px"),r&&(l=parseFloat(j)+o+p,k=parseFloat(h)+o+p)),e=ja(g,d[f],j+" "+h,l+" "+k,!1,"0px",e);return e},prefix:!0,formatter:ta("0px 0px 0px 0px",!1,!0)});w("backgroundPosition",{defaultValue:"0 0",parser:function(a,
b,c,d,e,g){var c=i||fa(a,null),c=this.format((c?C?c.getPropertyValue("background-position-x")+" "+c.getPropertyValue("background-position-y"):c.getPropertyValue("background-position"):a.currentStyle.backgroundPositionX+" "+a.currentStyle.backgroundPositionY)||"0 0"),b=this.format(b),f,k,h,m;if(c.indexOf("%")!==-1!==(b.indexOf("%")!==-1)&&(k=B(a,"backgroundImage").replace(U,""))&&k!=="none"){d=c.split(" ");f=b.split(" ");Y.setAttribute("src",k);for(k=2;--k>-1;)c=d[k],h=c.indexOf("%")!==-1,h!==(f[k].indexOf("%")!==
-1)&&(m=k===0?a.offsetWidth-Y.width:a.offsetHeight-Y.height,d[k]=h?parseFloat(c)/100*m+"px":parseFloat(c)/m*100+"%");c=d.join(" ")}return this.parseComplex(a.style,c,b,e,g)},formatter:ma});w("backgroundSize",{defaultValue:"0 0",formatter:ma});w("perspective",{defaultValue:"0px",prefix:!0});w("perspectiveOrigin",{defaultValue:"50% 50%",prefix:!0});w("transformStyle",{prefix:!0});w("backfaceVisibility",{prefix:!0});w("margin",{parser:ua("marginTop,marginRight,marginBottom,marginLeft")});w("padding",
{parser:ua("paddingTop,paddingRight,paddingBottom,paddingLeft")});w("clip",{defaultValue:"rect(0px,0px,0px,0px)",parser:function(a,b,c,d,e,g){C<9?(d=a.currentStyle,c=C<8?" ":",",d="rect("+d.clipTop+c+d.clipRight+c+d.clipBottom+c+d.clipLeft+")",b=this.format(b).split(",").join(c)):(d=this.format(B(a,this.p,i,!1,this.dflt)),b=this.format(b));return this.parseComplex(a.style,d,b,e,g)}});w("textShadow",{defaultValue:"0px 0px 0px #999",color:!0,multi:!0});w("autoRound,strictUnits",{parser:function(a,b,
c,d,e){return e}});w("border",{defaultValue:"0px solid #000",parser:function(a,b,c,d,e,g){return this.parseComplex(a.style,this.format(B(a,"borderTopWidth",i,!1,"0px")+" "+B(a,"borderTopStyle",i,!1,"solid")+" "+B(a,"borderTopColor",i,!1,"#000")),this.format(b),e,g)},color:!0,formatter:function(a){var b=a.split(" ");return b[0]+" "+(b[1]||"solid")+" "+(a.match(da)||["#000"])[0]}});w("float,cssFloat,styleFloat",{parser:function(a,b,c,d,e){a=a.style;d="cssFloat"in a?"cssFloat":"styleFloat";return new I(a,
d,0,0,e,-1,c,!1,0,a[d],b)}});var Fa=function(a){var b=this.t,c=b.filter,a=this.s+this.c*a|0,e;if(a===100)c.indexOf("atrix(")===-1&&c.indexOf("radient(")===-1?(b.removeAttribute("filter"),e=!B(this.data,"filter")):(b.filter=c.replace(aa,""),e=!0);if(!e){if(this.xn1)b.filter=c=c||"alpha(opacity=100)";c.indexOf("opacity")===-1?b.filter+=" alpha(opacity="+a+")":b.filter=c.replace(d,"opacity="+a)}};w("opacity,alpha,autoAlpha",{defaultValue:"1",parser:function(a,b,c,d,e,g){var f=parseFloat(B(a,"opacity",
i,!1,"1")),k=a.style,h,b=parseFloat(b);if(c==="autoAlpha")h=B(a,"visibility",i),f===1&&h==="hidden"&&b!==0&&(f=0),e=new I(k,"visibility",0,0,e,-1,null,!1,0,f!==0?"visible":"hidden",b===0?"hidden":"visible"),e.xs0="visible",d._overwriteProps.push(e.n);A?e=new I(k,"opacity",f,b-f,e):(e=new I(k,"opacity",f*100,(b-f)*100,e),e.xn1=c==="autoAlpha"?1:0,k.zoom=1,e.type=2,e.b="alpha(opacity="+e.s+")",e.e="alpha(opacity="+(e.s+e.c)+")",e.data=a,e.plugin=g,e.setRatio=Fa);return e}});var ya=function(a,b){b&&
(a.removeProperty?a.removeProperty(b.replace(Q,"-$1").toLowerCase()):a.removeAttribute(b))},Ga=function(a){this.t._gsClassPT=this;if(a===1||a===0){this.t.className=a===0?this.b:this.e;for(var b=this.data,c=this.t.style;b;)b.v?c[b.p]=b.v:ya(c,b.p),b=b._next;if(a===1&&this.t._gsClassPT===this)this.t._gsClassPT=null}else if(this.t.className!==this.e)this.t.className=this.e};w("className",{parser:function(a,b,c,d,e,g,f){var k=a.className,h=a.style.cssText,m,j,l,e=d._classNamePT=new I(a,c,0,0,e,2);e.setRatio=
Ga;e.pr=-11;p=!0;e.b=k;c=ga(a,i);if(m=a._gsClassPT){j={};for(l=m.data;l;)j[l.p]=1,l=l._next;m.setRatio(1)}a._gsClassPT=e;e.e=b.charAt(1)!=="="?b:k.replace(RegExp("\\s*\\b"+b.substr(2)+"\\b"),"")+(b.charAt(0)==="+"?" "+b.substr(2):"");if(d._tween._duration)a.className=e.e,b=na(a,c,ga(a),f,j),a.className=k,e.data=b.firstMPT,a.style.cssText=h,e=e.xfirst=d.parse(a,b.difs,e,g);return e}});var Ha=function(a){if((a===1||a===0)&&this.data._totalTime===this.data._totalDuration)for(var a=this.e==="all",b=this.t.style,
c=a?b.cssText.split(";"):this.e.split(","),d=c.length,e=k.transform.parse,g;--d>-1;)g=c[d],a&&(g=g.substr(0,g.indexOf(":")).split(" ").join("")),k[g]&&(g=k[g].parse===e?S:k[g].p),ya(b,g)};w("clearProps",{parser:function(a,b,c,d,e){e=new I(a,c,0,0,e,2);e.setRatio=Ha;e.e=b;e.pr=-10;e.data=d._tween;p=!0;return e}});e="bezier,throwProps,physicsProps,physics2D".split(",");for(N=e.length;N--;)K(e[N]);e=b.prototype;e._firstPT=null;e._onInitTween=function(a,c,d){if(!a.nodeType)return!1;this._target=a;this._tween=
d;this._vars=c;u=c.autoRound;p=!1;m=c.suffixMap||b.suffixMap;i=fa(a,"");g=this._overwriteProps;var d=a.style,e,f,k,h;if(O&&d.zIndex===""&&(e=B(a,"zIndex",i),e==="auto"||e===""))d.zIndex=0;if(typeof c==="string"){f=d.cssText;e=ga(a,i);d.cssText=f+";"+c;e=na(a,e,ga(a)).difs;if(!A&&l.test(c))e.opacity=parseFloat(RegExp.$1);c=e;d.cssText=f}this._firstPT=c=this.parse(a,c,null);if(this._transformType){e=this._transformType===3;if(S){if(t){O=!0;if(d.zIndex===""&&(h=B(a,"zIndex",i),h==="auto"||h===""))d.zIndex=
0;if(z)d.WebkitBackfaceVisibility=this._vars.WebkitBackfaceVisibility||(e?"visible":"hidden")}}else d.zoom=1;for(d=c;d&&d._next;)d=d._next;h=new I(a,"transform",0,0,null,2);this._linkCSSP(h,null,d);h.setRatio=e&&Z?Da:S?Ea:Ca;h.data=this._transform||ia(a,i,!0);g.pop()}if(p){for(;c;){a=c._next;for(d=f;d&&d.pr>c.pr;)d=d._next;(c._prev=d?d._prev:k)?c._prev._next=c:f=c;(c._next=d)?d._prev=c:k=c;c=a}this._firstPT=f}return!0};e.parse=function(a,b,c,d){var e=a.style,g,h,j,l,n,o,t,p;for(g in b){n=b[g];if(h=
k[g])c=h.parse(a,n,g,this,c,d,b);else if(h=B(a,g,i)+"",t=typeof n==="string",g==="color"||g==="fill"||g==="stroke"||g.indexOf("Color")!==-1||t&&F.test(n))t||(n=qa(n),n=(n.length>3?"rgba(":"rgb(")+n.join(",")+")"),c=ja(e,g,h,n,!0,"transparent",c,0,d);else if(t&&(n.indexOf(" ")!==-1||n.indexOf(",")!==-1))c=ja(e,g,h,n,!0,null,c,0,d);else{o=(j=parseFloat(h))||j===0?h.substr((j+"").length):"";if(h===""||h==="auto")if(g==="width"||g==="height"){j=a;p=g;l=i;o=parseFloat(p==="width"?j.offsetWidth:j.offsetHeight);
p=za[p];var q=p.length;for(l=l||fa(j,null);--q>-1;)o-=parseFloat(B(j,"padding"+p[q],l,!0))||0,o-=parseFloat(B(j,"border"+p[q]+"Width",l,!0))||0;j=o;o="px"}else g==="left"||g==="top"?(j=ra(a,g,i),o="px"):(j=g!=="opacity"?0:1,o="");(p=t&&n.charAt(1)==="=")?(l=parseInt(n.charAt(0)+"1",10),n=n.substr(2),l*=parseFloat(n),t=n.replace(f,"")):(l=parseFloat(n),t=t?n.substr((l+"").length)||"":"");t===""&&(t=m[g]||o);n=l||l===0?(p?l+j:l)+t:b[g];if(o!==t&&t!==""&&(l||l===0))if(j||j===0)if(j=H(a,g,j,o),t==="%"?
(j/=H(a,g,100,"%")/100,j>100&&(j=100),b.strictUnits!==!0&&(h=j+"%")):t==="em"?j/=H(a,g,1,"em"):(l=H(a,g,l,t),t="px"),p&&(l||l===0))n=l+j+t;p&&(l+=j);(j||j===0)&&(l||l===0)?(c=new I(e,g,j,l-j,c,0,"css_"+g,u!==!1&&(t==="px"||g==="zIndex"),0,h,n),c.xs0=t):!n&&(n+""==="NaN"||n==null)?window.console&&console.log("invalid "+g+" tween value: "+b[g]):(c=new I(e,g,l||j||0,0,c,-1,"css_"+g,!1,0,h,n),c.xs0=n==="none"&&(g==="display"||g.indexOf("Style")!==-1)?h:n)}if(d&&c&&!c.plugin)c.plugin=d}return c};e.setRatio=
...
this.transitions={};this.duration=3;this.defaultin="fadeIn";this.defaultout="fadeOut"},p=h.prototype;p.setDefaultContentTarget=function(b){console.log("setDefaultContentTarget",b);this.$contentTarget=b};p.getTransitionSequence=function(h,i,g){console.log("transition sequence",h,i,g);if(i!=void 0){var k=[],e,a=[];i.each(function(){var b=q(this),c=b.data("rel");c!=e?(e=c,a.push(b)):a[a.length-1]=a[a.length-1].add(b)});for(var i=0,j=a.length;i<j;i++){var c=this.getTransitionStep(h,g,a[i]);k.push(c)}h==
"out"&&k.reverse();console.log("transitionList",k);h=new TimelineLite({paused:!0});h.add(new b.to({},1.0E-4,{dummy:0}));h.add(k,null,"sequence");return h}};p.getTransitionStep=function(h,i,g){console.log("getTransitionStep",h,i,g);var k=this;i.hold();var e,a;h=="in"?(e=function(){console.log("in onStart");k.on.transitionIn.dispatch();for(var a=0,b=g.length;a<b;a++){var c=q(g[a]),e;e=c.data("contenttarget");e!=void 0&&e!=""?(console.log("provided $contentTarget",e),e=q(e)):(console.log("default $contentTarget",
k.$contentTarget),e=k.$contentTarget);e.append(c)}},a=function(){console.log("in onComplete");i.release()}):h=="out"&&(e=function(){console.log("out onStart");k.on.transitionOut.dispatch()},a=function(){console.log("out onComplete");i.release();for(var a=0,b=g.length;a<b;a++){var c=q(g[a]);k.$hidden.prepend(c)}});console.log("transition step",g.length);var j=new TimelineLite;j.eventCallback("onStart",e);j.eventCallback("onComplete",a);e=[];e.push(new b.to({},k.duration,{dummy:0}));a=0;for(var c=g.length;a<
c;a++){var n=q(g[a]),f=n.data("transition"+h);k.transitions[f]==void 0&&(f=k["default"+h]);n=k.transitions[f](n);e.push(n)}console.log("xition",f);console.log(k.transitions[f]);j.add(e,null,"start");return j};p.registerTransitions=function(b){var b=new b(this.giga,this),i;for(i in b)typeof b[i]=="function"&&(console.log("registerTransition:",i),this.transitions[i]=b[i].bind(b))};return h});
...
define("test/Transitions",["require","jquery","lib/tween/easing/EasePack","lib/tween/TweenLite","lib/tween/plugins/CSSPlugin"],function(h){h("jquery");h("lib/tween/easing/EasePack");var q=h("lib/tween/TweenLite");h("lib/tween/plugins/CSSPlugin");var h=function(b,h){console.log("new TestTransitions");this.giga=b;this.transitionManager=h},j=h.prototype;j.fadeIn=function(b){console.log("GET fadeIn fn");b.css({opacity:0});return q.to(b,this.transitionManager.duration,{opacity:1})};j.fadeOut=function(b){console.log("GET fadeOut fn");
b.css({opacity:1});return q.to(b,this.transitionManager.duration,{opacity:0})};j.listIn=function(b){console.log("GET listIn fn");b.css({position:"relative"});return q.fromTo(b,this.transitionManager.duration,{left:-100},{left:0})};j.listOut=function(b){console.log("GET listOut fn");b.css({position:"relative"});return q.fromTo(b,this.transitionManager.duration,{left:0},{left:-100})};j.projectIn=function(b){console.log("GET projectIn fn");var h=this;return function(){console.log("projectIn");b.hide();
b.slideDown({duration:h.transitionManager.duration*1E3})}};j.projectOut=function(b){console.log("GET projectOut fn");var h=this;return function(){console.log("projectOut");b.slideUp({duration:h.transitionManager.duration*1E3})}};return h});
